...
async function preparedBridge(t) {
 ...
 const review=dispatchGoalReview(f.root,f.runId,{transport:'bridge',fence:f.fence,home:installed.home,env:installed.env}).review;
 ...
 startGoalReview(f.root,f.runId,{id:review.id,attemptId:review.execution.attempt_id,handle:`goal-bridge:${review.execution.attempt_id}`,fence:f.fence});
