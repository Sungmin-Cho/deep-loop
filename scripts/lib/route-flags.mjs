...
export const ROUTE_FLAGS = Object.freeze({
  ...
  'execution prepare': route(['episode', 'mode', 'stage', 'task', 'routing', ...F, ...L]),
  'execution start': route(['episode', 'attempt', 'handle', ...F, ...L]),
  'execution return': route(['episode', 'attempt', 'artifacts', 'observation', ...F, ...L]),
  'execution reconcile': route(['episode', 'attempt', 'observation', ...F, ...L]),
